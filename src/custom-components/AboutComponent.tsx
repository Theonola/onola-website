  ...
  return (
    <section className='bg-white '>
      <div className='flex flex-col md:flex-row w-full min-h-[460px]'>
        ...
        {/* TEXT — right half */}
        <div className='w-full md:w-1/2 flex items-center px-10 py-12 md:px-16 lg:px-24 bg-white'>
          <div className='max-w-lg'>
            ...
            <p className='text-gray-500 text-[15px] leading-relaxed mb-10'>
              ...
              most urgent challenges can only be solved by those who understand
              them deeply, have lived them directly, and have already delivered
              real solutions. As a locally-grounded organization, Onola bridges
              the gap between policy and the community, driven by local
              expertise and a commitment to meaningful impact.
            </p>
