...
export const thematicAreas = [
  {
    ...
    description: "Focuses on delivering clean, accessible, and sustainable water sources to communities. Includes infrastructure development, boreholes and purification systems"
  },
  {
    name: "Primary Healthcare",
    icon: FaClinicMedical,
    description: "Aims to provide essential medical services, disease prevention, maternal and child health, and access to clinics in underserved areas."
  },
  {
    name: "Waste Management",
    icon: FaTrashAlt,
    description: "Promotes effective and environmentally sound waste collection, disposal, and recycling systems. Emphasizes community awareness, sanitation improvement."
  },
  {
    name: "Basic Education",
    icon: FaBook,
    description: "Supports universal access to quality primary education by improving school infrastructure, teacher training, and learning resources.."
  },
  {
    name: "Transportation",
    icon: FaBus,
    description: "Improves access to reliable and safe transportation options. Enhances connectivity to schools, health centers, and markets, particularly in rural communities."
  },
  {
    name: "Agriculture & Nutrition",
    icon: FaSeedling,
    description: "Boosts food security and rural livelihoods through sustainable farming practices, access to tools, training, and markets. "
  },
